...
class QMixer(nn.Module):
    def __init__(self, n_agents, state_shape, mixing_embed_dim, q_embed_dim,
        ...
        self.optimizer = optim.Adam(self.parameters(), lr=lear_rate)
        self.device = T.device('cuda:0' if T.cuda.is_available() else 'cuda:1')
        self.to(self.device)
...
# qmixer = QMixer(n_agents=2, state_shape=64, mixing_embed_dim= 256, q_embed_dim=1)
# print(qmixer.parameters())
# print(dict(qmixer.named_parameters()))